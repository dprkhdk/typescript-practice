...
console.log(echo("Hello, Generics!")); // Output: Hello, Generics!
console.log(echo(42)); // Output: 42
console.log(echo(true)); // Output: true
console.log(echo({ key: "value" })); // Output: { key: "value" }
console.log(echo(["apple", "banana", "cherry"])); // Output: ["apple", "banana", "cherry"]
const usersGeneric = [
    { name: 'Alice', age: 30 },
    { name: 'Bob', age: 25 },
    { name: 'Charlie', age: 35 }
